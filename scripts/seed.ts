  ...
  await TutorProfile.insertMany([
    {
      ...
      availability: [
        { dayOfWeek: 1, startHour: 18, endHour: 20, durationMin: 60 },
        { dayOfWeek: 3, startHour: 18, endHour: 20, durationMin: 60 },
        { dayOfWeek: 5, startHour: 17, endHour: 19, durationMin: 60 },
      ],
      rating: 4.9,
      reviewCount: 124,
      avatarSeed: "mariam",
    ...
    },
    {
      ...
      availability: [
        { dayOfWeek: 2, startHour: 17, endHour: 20, durationMin: 60 },
        { dayOfWeek: 4, startHour: 16, endHour: 18, durationMin: 60 },
      ],
      rating: 4.8,
      reviewCount: 87,
      avatarSeed: "vakhtang",
    ...
    },
    {
      ...
      availability: [
        { dayOfWeek: 1, startHour: 16, endHour: 18, durationMin: 60 },
        { dayOfWeek: 3, startHour: 16, endHour: 18, durationMin: 60 },
        { dayOfWeek: 6, startHour: 11, endHour: 14, durationMin: 60 },
      ],
      rating: 4.95,
      reviewCount: 156,
      avatarSeed: "sofo",
    ...
    },
    {
      ...
      availability: [
        { dayOfWeek: 2, startHour: 19, endHour: 21, durationMin: 60 },
        { dayOfWeek: 5, startHour: 18, endHour: 20, durationMin: 60 },
        { dayOfWeek: 6, startHour: 10, endHour: 12, durationMin: 60 },
      ],
      rating: 4.7,
      reviewCount: 42,
      avatarSeed: "beka",
